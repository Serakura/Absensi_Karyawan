<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow ">
    ...
    <div class="d-flex flex-row bd-highlight mr-auto">
        ...
        <h5 class="fw-bolder my-auto text-secondary"><b><i>Lembaga Bantuan Hukum Harapan</i></b></h5>
    </div>
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                    ...
                    if ($role == 'admin') {
                        echo $result['nama_admin'];
                    } else {
                        echo $result['nama_karyawan'];
                    }
                    ?>
                </span>
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <?php if ($role != 'admin') { ?>
                    <a class="dropdown-item disabled d-block d-md-none">
                        ...
                        if ($role == 'karyawan') {
                            $query = mysqli_query($koneksi, "SELECT nip,nama_karyawan,foto FROM karyawan WHERE username='$id'");
                        }
                        ...
                        ?>
                            ...
                            <p class=" text-center mt-1" style="color: black;"><?php if ($role == 'karyawan') {
                                                                                    echo $rw['nip'];
                                                                                }  ?></p>
                        <?php
